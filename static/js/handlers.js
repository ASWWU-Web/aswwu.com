...
function electionHandler() {
  if (!user.wwuid) {
      main.html("<div class='row'><div class='small-12 columns'>"+
                  ...
                  "<h3><a rel="nofollow" href='https://saml.aswwu.com?redirectURI=/#/election' style='color: white;'>Login</a></h3>"+
                  "</div></div>");
      return;
  }
...
function senateElectionHandler() {
   if (!user.wwuid) {
      main.html("<div class='row'><div class='small-12 columns'>"+
                  "<h1 style='color:white;'>You must login to access this page</h1><br>"+
                  "<h3><a rel="nofollow" href='https://saml.aswwu.com?redirectURI=/#/senate_election' data-reveal-id='login-modal' style='color: white;'>Login</a></h3>"+
                  "</div></div>");
      return;
  }
...
function volunteerHandler() {
    if (!user.wwuid) {
        main.html("<div class='row'><div class='small-12 columns'>"+
                    "<h1 style='color:white;'>You must login to access this page</h1><br>"+
                    "<h3><a rel="nofollow" href='https://saml.aswwu.com?redirectURI=/#/volunteer' data-reveal-id='login-modal' style='color: white;'>Login</a></h3>"+
                    "</div></div>");
        return;
    }
